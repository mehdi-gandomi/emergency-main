  ...
  return (
    <div className="space-y-2">
      ...
      <RadioGroup
        ...
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-right"
      >
        <div className={`flex flex-row-reverse items-center justify-between gap-3 rounded-xl border-2 p-4 transition-all duration-200 cursor-pointer hover:shadow-md ${
          ...
          <Label htmlFor="contact_type-emdadi" className="flex-1 cursor-pointer flex items-center gap-3 justify-between">
            <span className="font-medium">اضطراری</span>
        ...
        <div className={`flex flex-row-reverse items-center justify-between gap-3 rounded-xl border-2 p-4 transition-all duration-200 cursor-pointer hover:shadow-md ${
          ...
          <Label htmlFor="contact_type-emdadi-not-urgent" className="flex-1 cursor-pointer flex items-center gap-3 justify-between">
            <span className="font-medium">غیراضطراری</span>
            <div className="p-2 rounded-lg bg-emerald-100 dark:bg-emerald-900/30">
        ...
        <div className={`flex flex-row-reverse items-center justify-between gap-3 rounded-xl border-2 p-4 transition-all duration-200 cursor-pointer hover:shadow-md ${
          ...
          <Label htmlFor="contact_type-mazahim" className="flex-1 cursor-pointer flex items-center gap-3 justify-between">
            <span className="font-medium">مزاحم</span>
        ...
        <div className={`flex flex-row-reverse items-center justify-between gap-3 rounded-xl border-2 p-4 transition-all duration-200 cursor-pointer hover:shadow-md ${
          ...
          <Label htmlFor="not-completed" className="flex-1 cursor-pointer flex items-center gap-3 justify-between">
            <span className="font-medium">ناتمام</span>
            <div className="p-2 rounded-lg bg-red-100 dark:bg-red-900/30">
