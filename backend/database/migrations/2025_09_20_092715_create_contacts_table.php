...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('contacts', function (Blueprint $table) {
            ...
            $table->tinyInteger('report_event_type')->nullable()->comment('نوع حادثه اعلامی');
            $table->tinyInteger('device')->nullable()->comment('نام دستگاه');
            $table->tinyInteger('event_details_status')->nullable()->comment('درحال انجام/پایان عملیات');
            ...
            $table->tinyInteger('alarm_status')->nullable()->comment('آلارم');
